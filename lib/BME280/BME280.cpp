...
void BME280::begin(int BME280_ADDRESS) {
    ...
    writeReg(0xF2,ctrl_hum_reg,BME280_ADDRESS);
    writeReg(0xF4,ctrl_meas_reg,BME280_ADDRESS);
    writeReg(0xF5,config_reg,BME280_ADDRESS);
    readTrim(BME280_ADDRESS);                    //
}

double BME280::readTemperature(int BME280_ADDRESS) {
...
double BME280::readPressure(int BME280_ADDRESS) {
...
double BME280::readHumidity(int BME280_ADDRESS) {
...
void BME280::writeReg(uint8_t reg_address, uint8_t data, int BME280_ADDRESS) {
    Wire.beginTransmission(BME280_ADDRESS);
...
void BME280::readTrim(int BME280_ADDRESS) {
    uint8_t data[32],i=0;
    Wire.beginTransmission(BME280_ADDRESS);
    Wire.write(0x88);
    Wire.endTransmission();
